...
@section('content')
    ...
    <div class="md:flex justify-between">
        ...
        <div class="md:flex">
            <a href="penjualan-tbs/pilih-rekening">
                <button
                    class="bg-amber-400 opacity-85 rounded-sm p-2 md:mb-0 mb-5 mx-1 mt-1 font-medium text-sm lg:text-base antialiased">Tautkan
                    Rekening</button>
            </a>
            <form action="" id="tahun" class="md:mx-2 mx-1 md:mb-0 mb-5 my-auto">
    ...
    <div> {{-- class="w-full my-2 bg-zinc-400 h-[1px]" --}}
        {{-- SECTION Tabel Data --}}
