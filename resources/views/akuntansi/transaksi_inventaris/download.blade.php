...
@section('content')
    ...
    <div class="flex flex-col mt-5">
        <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 ">
            <div class="inline-block min-w-full overflow-hidden border border-zinc-800 align-middle shadow-sm sm:rounded-sm">
                <table class="min-w-full">
                    ...
                    <tbody class="bg-white">
                        @for ($i = 0; $i < $transaksi->count(); $i++)
                            ...
                            <tr>
                                <td
                                    class="font-medium pl-4 pr-2 sm:px-6 py-3 text-sm leading-5 text-gray-800 whitespace-no-wrap border-b border-r border-zinc-800">
                                    {{ $u }}
                                </td>
                                <td
                                    class="font-medium px-4 sm:px-4 py-3 text-sm leading-5 text-gray-800 whitespace-no-wrap border-b border-r border-zinc-800">
                                ...
                                <td
                                    class="text-left font-medium px-4 sm:px-4 py-3 text-sm leading-5 text-gray-800 whitespace-no-wrap border-b border-r border-zinc-800">
                                    {{ $transaksi[$i]->keterangan }}
                                </td>
                                <td class="px-4 sm:px-4 py-3 whitespace-no-wrap border-b border-zinc-800">
