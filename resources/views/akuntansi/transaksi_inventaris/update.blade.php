            ...
            <div class="md:flex md:justify-between">
                ...
                <div class="md:w-5/12">
                    <div class="md:flex mb-6">
                        ...
                        <div class="md:w-4/6">
                            <textarea class="form-textarea block w-full focus:bg-white" id="my-textarea" value="" rows="6"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="md:flex mb-6">
                        ...
                        <div class="md:w-4/6 relative">
                            ...
                            <input class="form-input block w-full focus:bg-white pl-9" id="my-textfield" type="number">
                        </div>
                    </div>
                </div>
            </div>
