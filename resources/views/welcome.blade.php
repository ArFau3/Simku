    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="mt-16">
                ...
                {{-- SEMENTARA, JIKA BEDA SISTE LOGIN --}}
                <div class="mb-5 flex justify-between">
                    <a href="akuntansi">
                        <button class="bg-amber-400 opacity-80 p-2 mt-1 text-lg font-bold lg:text-base antialiased">
                            Login Akuntansi</button>
                    </a>
                    <a href="supplier">
                        <button class="bg-amber-400 opacity-80 p-2 mt-1 text-lg font-bold lg:text-base antialiased">
                            Login Supplier</button>
                    </a>
                </div>
                {{-- END SEMENTARA --}}
