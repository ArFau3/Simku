    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                ...
                <p class="text-xl mx-3 font-extrabold tracking-tighter">SISTEM KOPERASI</p>
            ...
            <div class="mt-16">
                <div class="mb-7 flex justify-between">
                    ...
                    <div class="w-4/6 flex justify-between">
                        <a href="/dashboard">
                            <button
                                class="bg-cyan-400 text-zinc-900 opacity-80 p-2 mt-1 text-lg tracking-tight font-extrabold lg:text-base antialiased">
                                Sistem Akuntansi</button>
                        </a>
                        <a href="/beranda">
                            <button
                                class="bg-cyan-400 text-zinc-900 opacity-80 p-2 mt-1 text-lg tracking-tight font-extrabold lg:text-base antialiased">
                                Sistem Supplier</button>
                        </a>
                    </div>
                    <div class="w-1/6"></div>
                </div>
